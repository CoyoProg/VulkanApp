...
int VulkanRenderer::init(GLFWwindow* windowP)
{
	...
	try
	{
		...
		viewProjection.view = glm::lookAt(glm::vec3(30.0f, 30.0f, 60.0f),
		...
		// Default texture
		createTexture("cottage_diffuse.png");
	}
...
void VulkanRenderer::createGraphicsPipeline()
{
	...
	auto vertexShaderCode = readShaderFile("shader.vert.spv");
	auto fragmentShaderCode = readShaderFile("shader.frag.spv");
